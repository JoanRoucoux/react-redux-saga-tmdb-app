...
const AccountWatchlistMoviesReducer = (state = initialState, action) => Matcher()
  .on(
    () => action.type === AccountActionTypes.ACCOUNT_WATCHLIST_MOVIES_REQUEST,
    () => ({
      ...state,
      personPopularResults: null,
      personPopularCurrentPage: null,
  ...
  .on(
    () => action.type === AccountActionTypes.ACCOUNT_WATCHLIST_MOVIES_REQUEST_SUCCESS,
    () => ({
      ...state,
  ...
  .on(
    () => action.type === AccountActionTypes.ACCOUNT_WATCHLIST_MOVIES_REQUEST_FAILURE,
    () => ({
      ...state,
      personPopularResults: null,
      personPopularCurrentPage: null,
...
export default AccountWatchlistMoviesReducer;
