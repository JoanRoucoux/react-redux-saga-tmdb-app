...
const AccountFavoriteTvReducer = (state = initialState, action) => Matcher()
  .on(
    () => action.type === AccountActionTypes.ACCOUNT_FAVORITE_TV_REQUEST,
    () => ({
      ...state,
      personPopularResults: null,
      personPopularCurrentPage: null,
  ...
  .on(
    () => action.type === AccountActionTypes.ACCOUNT_FAVORITE_TV_REQUEST_SUCCESS,
    () => ({
      ...state,
  ...
  .on(
    () => action.type === AccountActionTypes.ACCOUNT_FAVORITE_TV_REQUEST_FAILURE,
    () => ({
      ...state,
      personPopularResults: null,
      personPopularCurrentPage: null,
...
export default AccountFavoriteTvReducer;
